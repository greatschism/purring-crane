...
(function() {
	...
	HT.View.createSummaryPane = function(_args) {
		...
		var Pane = Titanium.UI.createView(HT.combine(defaults.theme, {
			width : 160,
			height : 52,
			top : 0
		}));

		Pane.add(Titanium.UI.createLabel(HT.combine(styles['CardRibbonDarkText_' + defaults.direction], {
			text : _args.label,
			height : 12,
			top : 10,
			left : 10,
		...
		var LargeNumberLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonWhiteText_' + defaults.direction], {
			text : _args.value,
			height : 25,
			bottom : 5,
			left : 10,
	...
	HT.View.createFieldset = function(_args) {
		...
		var formView = Ti.UI.createView(HT.combine(styles.FormView, {
	...
	HT.View.createFormRow = function(_args, win) {
		...
		var keyboardType = _args.keyboardType || Titanium.UI.KEYBOARD_DEFAULT;
		...
		switch (_args.type) {
			case "options":
				...
				break;
			case "date_field":
				var BackButton = HT.View.customBackButton({
					title : "Cancel"
				});
				var SaveButton = Titanium.UI.createButton(HT.combine(styles.BaseButton, {
					width : 60,
					title : "Save",
					backgroundImage : path + "images/square_button.png"
				}));

				var DateWindow = Titanium.UI.createWindow(HT.combine(styles.BaseWindow, styles.YellowGradientWindow, {
					height : 460,
					title : "Set Holding Date",
					leftNavButton : BackButton,
					rightNavButton : SaveButton,
					backgroundImage : path + "images/bg_date_picker.png"
				}));
	...
	HT.View.createCard = function(_args) {
		...
		var CardRibbonView = Titanium.UI.createView(HT.combine(styles['CardRibbonBG_' + ribbonStyle], {
			width : cardWidth + 2,
			height : 122,
			top : 97,
			left : -1,
		...
		var CardRibbonBorderBottom = Titanium.UI.createView(HT.combine(styles['CardRibbonBottomBorder_' + ribbonStyle], {
			width : cardWidth,
			height : 1,
			right : 0,
			bottom : 1,
	...
	HT.View.createHoldingsCards = function(_args) {
		...
		for(var i = 0, len = data.length; i < len; i++) {
			...
			var AccountHolderLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonAccentText_' + direction], {
				width : "auto",
				height : 16,
				top : 0,
				left : 0,
			...
			var AccountValueLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonWhiteText_' + direction], {
				width : "auto",
				height : 35,
				text : holdingValue,
				top : 20,
			...
			var AccountDateAddedLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonDarkText_' + direction], {
				width : "auto",
				height : 13,
				top : 62,
				left : 0,
			...
			// Bottom strip
			var LastRefresh = HT.View.createMessageView({
				text : "Balance as of Mar 28, 2011 at 10:50AM GMT+01:00"
			});
		...
		var CardsScrollView = Titanium.UI.createScrollableView(HT.combine(styles.CardScroller, {
			views : cards
		}));
	...
	HT.View.createAccountsCards = function(_args) {
		...
		for(var _i = 0, len = data.length; _i < len; _i++) {
			...
			var AccountHolderLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonAccentText_default'], {
				width : "auto",
				height : 16,
				top : 0,
				left : 0,
			...
			var AccountValueLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonWhiteText_default'], {
				width : "auto",
				height : 35,
				text : holdingValue,
				top : 20,
			...
			var AccountPercentageLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonDarkText_default'], {
				width : "auto",
				height : 13,
				top : 62,
				left : 0,
			...
			CardButton2.addEventListener("click", function(e) {
				...
				DisconnectAlertDialog.addEventListener("click", function(e) {
					if(e.index === 1) {
						CardsScrollView.fireEvent("disconnect", {
							cardIndex : _cardID
						});
					}
				});
	...
	HT.View.createMarketsCards = function(_args) {
		...
		for(var i = 0, len = data.length; i < len; i++) {
			...
			_views.CurrentPositionsLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonDarkText_' + direction], {
				top : 0,
				left : 0,
				height : 14,
			...
			_views.AccountHolderLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonAccentText_' + direction], {
				width : "auto",
				height : 16,
				top : 0,
				left : 0,
			...
			_views.AccountValueLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonWhiteText_' + direction], {
				width : "auto",
				height : 37,
				text : marketValue,
				top : 16,
			...
			_views.HiLoLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonWhiteText_' + direction], {
				width : "auto",
				height : 13,
				top : 54,
				left : 0,
			...
			_views.LatestPriceHeaderLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonDarkText_' + direction], {
				width : 'auto',
				top : 78,
				left : 0,
				height : 14,
			...
			_views.LatestPriceLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonAccentText_' + direction], {
				top : 75,
			...
			// Bottom strip
			_views.LastRefresh = HT.View.createMessageView({
				text : lastUpdateText
			});
	...
	HT.View.createPerformanceCards = function(_args) {
		...
		for(var i = 0, len = data.length; i < len; i++) {
			...
			var AccountHolderLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonDarkText_Performance_' + direction], {
				width : "auto",
				height : 16,
				top : 0,
				left : 0,
			...
			var ReturnLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonWhiteText_Performance_' + direction], {
				width : "auto",
				height : 37,
			...
			var CommissionsLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonAccentText_Performance_' + direction], {
				width : "auto",
				height : 13,
				top : 54,
				left : 0,
	...
	HT.View.createPerformanceHoldingsCards = function(_args) {
		...
		for(var i = 0, len = data.length; i < len; i++) {
			...
			var AccountHolderLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonAccentText_Performance_' + direction], {
				width : "auto",
				height : 18,
				top : 0,
				left : 0,
			...
			var AccountValueLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonWhiteText_Performance_' + direction], {
				width : "auto",
				height : 35,
				text : holdingValue,
				top : 20,
			...
			var AccountDateAddedLabel = Titanium.UI.createLabel(HT.combine(styles['CardRibbonDarkText_Performance_' + direction], {
				width : "auto",
				height : 13,
				top : 62,
				left : 0,
